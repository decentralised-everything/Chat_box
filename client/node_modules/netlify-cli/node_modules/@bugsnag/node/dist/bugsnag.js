...
_$Event_5.__type = 'nodejs';

/* removed: var _$delivery_33 = require('@bugsnag/delivery-node'); */; // extend the base config schema with some node-specific options


var __schema_36 = ___extends_36({}, _$config_4.schema, {}, _$config_35); // remove enabledBreadcrumbTypes from the config schema
...
var internalPlugins = [_$app_37, _$surroundingCode_42, _$inProject_41, _$stripProjectRoot_48, _$session_46, _$device_40, _$uncaughtException_43, _$unhandledRejection_44, _$intercept_39, _$contextualize_38];
var Bugsnag = {
  _client: null,
  createClient: function (opts) {
    ...
    if (!opts) opts = {};
    var bugsnag = new _$Client_3(opts, __schema_36, internalPlugins, {
      name: name,
      version: version,
      url: url
    });
...
_$notifier_36.Client = _$Client_3;
_$notifier_36.Event = _$Event_5;
_$notifier_36.Session = _$Session_32;
_$notifier_36.Breadcrumb = _$Breadcrumb_2; // Export a "default" property for compatibility with ESM imports
